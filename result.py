...
print(Y_train)
print(predictions[0][np.arange(Y_train.shape[0]), Y_train_flatten].shape)
LiRAScores = LiRAOnline(predictions[0][np.arange(Y_train.shape[0]), Y_train_flatten], predictions[1:, Y_train], inOutLabels[1:], eps=1e-6)
